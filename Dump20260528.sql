...
--
-- Host: cfif31.ru    Database: ISPr25-22_SafiulinaAD_priv
-- ------------------------------------------------------
...
CREATE TABLE `addres_delivery` (
  ...
  `addres_name` varchar(45) NOT NULL,
...
INSERT INTO `categoria` VALUES (1,'Женская обувь'),(2,'Мужская обувь');
...
CREATE TABLE `order` (
  ...
  `addres_delivery_id` int NOT NULL,
  `nsp_cl_id` int NOT NULL,
  `code` int NOT NULL,
  `status_id` int NOT NULL,
  PRIMARY KEY (`idorder`),
  KEY `fk_addres_delivery_id_idx` (`addres_delivery_id`),
  KEY `fk_nsp_cl_id_idx` (`nsp_cl_id`),
  KEY `fk_status_id_idx` (`status_id`),
  CONSTRAINT `fk_addres_delivery_id` FOREIGN KEY (`addres_delivery_id`) REFERENCES `addres_delivery` (`idaddres`),
  CONSTRAINT `fk_nsp_cl_id` FOREIGN KEY (`nsp_cl_id`) REFERENCES `user` (`iduser`),
  CONSTRAINT `fk_status_id` FOREIGN KEY (`status_id`) REFERENCES `status` (`idstatus`)
...
INSERT INTO `order_details` VALUES (1,'А112Т4',1,1),(2,'F635R4',4,1),(3,'H782T5',5,2),(4,'G783F5',4,2),(5,'J384T6',6,3),(6,'D572U8',7,3),(7,'F572H7',8,4),(8,'D329H3',6,4),(9,'А112Т4',5,5),(10,'F635R4',4,5),(11,'H782T5',7,6),(12,'G783F5',9,6),(13,'J384T6',9,7),(14,'D572U8',3,7),(15,'F572H7',5,8),(16,'D329H3',7,8),(17,'B320R5',8,9),(18,'G432E4',9,9),(19,'S213E3',9,10),(20,'E482R4',9,10);
...
INSERT INTO `product` VALUES (1,'А112Т4',1,1,4990.00,1,1,1,3,6,'Женские ,ботинки демисезонные 1','1.jpg'),(4,'G783F5',1,1,5900.00,1,3,2,2,8,'Мужские 1 3-Обувь кожаные с натуральным мехом','4.jpg'),(5,'J384T6',1,1,3800.00,2,4,2,2,16,'B3430/14 4 мужские 4','5.jpg'),(6,'D572U8',3,1,4100.00,2,3,2,3,6,'129615-4 3 мужские','6.jpg'),(7,'F572H7',2,1,2700.00,1,2,1,2,14,'2 2 женские летние, размер 39, цвет черный','7.jpg'),(11,'S213E3',4,1,2156.00,2,6,2,3,6,'407700/01-01 4 мужские 6',''),(14,'K345R4',4,1,2100.00,2,6,2,2,3,'407700/01-02 4 мужские 6',''),(15,'O754F4',2,1,5400.00,2,4,1,4,18,'2 женские демисезонные 4 артикул 55073-68/37',''),(16,'G531F4',1,1,6600.00,1,1,1,12,9,'1 женские зимние ROMER арт. 893167-01 Черный',''),(17,'J542F5',6,1,500.00,1,1,2,13,0,'Тапочки мужские Арт.70701-55-67син р.41',''),(18,'B431R5',1,1,2700.00,2,4,2,2,5,'Мужские кожаные 1/мужские 1',''),(19,'P764G4',2,1,6800.00,1,6,1,15,15,'2 женские, ARGO, размер 38',''),(20,'C436G5',1,1,10200.00,1,5,1,15,9,'1 женские, ARGO, размер 40',''),(21,'F427R5',1,1,11800.00,2,4,1,15,11,'1 на молнии с декоративной пряжкой FRAU',''),(22,'N457T5',4,1,4600.00,1,6,1,3,13,'4 1 черные зимние, мех',''),(24,'S326R5',6,1,9900.00,2,6,2,17,15,'Мужские кожаные тапочки \"Профиль С.Дали\" ',''),(26,'M542T5',3,1,2800.00,2,4,2,18,3,'3 мужские TOFA',''),(28,'T324F5',7,1,4699.00,1,6,1,2,5,'Сапоги замша Цвет: синий',''),(29,'K358H6',6,1,599.00,1,4,2,20,2,'Тапочки мужские син р.41','');
...
-- Dump completed on 2026-05-28 23:23:55
